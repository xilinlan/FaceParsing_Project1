...
from networks.modules.ddgcn import DDualGCNHead
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes):
        ...
        self.dual_gcn_head = DDualGCNHead(512, 256)
    ...
    def forward(self, x):
        ...
        gcn_output = self.dual_gcn_head(x)
        output = torch.cat([output, gcn_output], dim=1)
        return output
